class ImageUploadsController < ApplicationController
  ...
  def create
    ...
    directory_location = "#{APP_CONFIG[Rails.env]['upload_images_path']}/images/albums/#{directory_name}"
  ...
  def destroy
    ...
    FileUtils.rm("#{APP_CONFIG[Rails.env]['upload_images_path']}#{image.file_location}")
